...
class Utils {
	...
	void createInstance(String csar, String servicetemplate, String nodetemplates, Utils utils, String instanceID, String properties, String propertiesValue){
		...
		//set properties
		String properites = "<Properties><" + properties + ">" + propertiesValue + "</"+ properties + "></Properties>";
		utils.httpRequests(newInstance + "/properties/", properites, "PUT", "application/xml");
		//set state
